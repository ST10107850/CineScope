...
import captainMarvel from "../assets/Images/series/mandalorian.jpg"
import demonSlayer from "../assets/Images/cartoons/demon-slayer.jpg";
import bloodshot from "../assets/Images/series/mandalorian.jpg";
import wandaVision from "../assets/Images/series/wanda.png";
import batMan from "../assets/Images/Series/mandalorian.jpg";
...
const Series = () => {
  return (
    <div className="p-11">
      {/* Title Section */}
      <h2 className="text-3xl font-bold mb-8 text-center uppercase text-white">Featured Series</h2>
